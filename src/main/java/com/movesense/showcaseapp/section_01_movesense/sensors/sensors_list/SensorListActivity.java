...
import com.movesense.showcaseapp.custom_classes.JsonSender;
...
public class SensorListActivity extends BaseActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        Log.d("hello", "heellowoorlds");
        subscriptions.clear();
        Log.d("hello", "heellowoorld");
        Button button2;
        Button button3;
        switch (v.getId()) {
            case R.id.button2:
                Log.d("hello", "heellowoorld2");
                ...
                if (!isRecording) {
                    ...
                    JsonSender.Instance.jsonUpload(this, MultiSensorDataGatherer.Instance.getData());
                    button2.setBackgroundColor(Color.GREEN);
                    button3.setBackgroundColor(Color.GRAY);
                    Log.d("hello", "heellowoorld2yes");
                }
                isRecording = !isRecording;
                break;
            case R.id.button3:
                Log.d("hello", "heellowoorld3");
                button2 = (Button) findViewById(R.id.button2);
                button3 = (Button) findViewById(R.id.button3);
                if (!isRecording) {
